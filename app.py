...
for indice, linha in enumerate(sheet_alunos.iter_rows(min_row=2)):
    ...
    desenhar.text((1020, 828), nome_participante, fill = 'black', font = fonte_nome)
    desenhar.text((1060, 953), nome_curso, fill = 'black', font = fonte_geral)
    desenhar.text((1435, 1067), tipo_participacao, fill = 'black', font = fonte_geral)
    desenhar.text((1480, 1187), str(carga_horaria), fill = 'black', font = fonte_geral)
